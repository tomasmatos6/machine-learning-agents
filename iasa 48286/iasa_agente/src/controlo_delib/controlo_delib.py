...
class ControloDelib(Controlo):
    ...
    def __reconsiderar(self):
        """
            É necessário reconsiderar se o modelo mundo tiver sido alterado ou se não existir plano
        """
    ...
    def __deliberar(self):
        """
            Atualizar os objetivos com a lista de estado retornada pelo método deliberar() 
            do MecDelib
        """
